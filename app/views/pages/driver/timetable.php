...
<div class="timetable">
    ...
    foreach ($timeSlots as $slot) {
        ...
        foreach (array("Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday") as $day) {
            // Fetch activity for the current day and time slot from the database
            $sql = "SELECT activity, driver_id, vehicle_id FROM timetable WHERE day = '$day' AND time_slot = '$slot'";
            $result = $connection->query($sql);

            // Display the activity, driver_id, and vehicle_id if found, otherwise display an empty cell
