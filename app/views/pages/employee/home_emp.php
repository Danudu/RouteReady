        ...
        <div class="container">
            ...
            <div class="main">
                <section class="welcome">
                    ...
                    <div>
                        <button type="button" class="btn2"><a href="<?php echo URLROOT; ?>/employees/reservations" class="bt">Transport Reservation</a></button>
                        <button type="button" class="btn2"><a href="<?php echo URLROOT;;?>/employees/worktrip" class="bt">WorkTrip Reservation</a></button>
                    </div>
                </section>
            </div>
            <div class="footer">
