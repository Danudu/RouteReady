...
<div class="form-box">
<form action="<?php echo URLROOT; ?>/employees/updateMonthlyReservation" method="post" class="input-group" id="Daily">
            <input type="hidden" name="MReservationID" value="<?php echo $data['reservation']->MReservationID; ?>">
            <div class="column">
    ...
    <section class="section">
                ...
                <div class="date">
                <input type="date" name="StartDate" value="<?php echo $data['reservation']->StartDate; ?>">
            </div>
    </section>
