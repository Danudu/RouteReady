...
<?php endif; ?>
        ...
        <div class="form-box">
            ...
            <button type="button" class="toggle-btn" onclick="daily()">Daily Reservations</button>
               <button type="button" class="toggle-btn" onclick="monthly()">Monthly Reservations</button> 
                ...
                <form id="Daily" action="<?php echo URLROOT; ?>/employees/makeReservation" method="post" class="input-group">
                    <div class="column">
            ...
            <select name="schedule" id="schedule" class="schedule" onchange="changeRoute()" value="<?php echo $data['scheduleType']; ?>">
    ...
    <div class="column">
                <section class="section">
                    ...
                    <div class="date">
                        <input type="text" id="reservationDateDaily" name="Date" placeholder="reservation Date" readonly>
                    </div>
                </section>
                
        <section class="section" id="pickup">
            <span class="pickup-topic"></span><label for="pickup">Pick Up</label>
            <div class="pickup"> <input type="text" id="pickup" name="pickup" placeholder="Enter pickup city" value="<?php echo $data['pickup']; ?>"></div>
        </section>
    </div>
    ...
    <div class="column">
        <section class="section" id="dropoff">
            ...
            <div class="pickup">  <input type="text" id="dropoff" name="dropoff" placeholder="Enter drop off city" value="<?php echo $data['dropoff']; ?>"></div>
        </section>
    </div>
        ...
        <form id="Monthly" action="<?php echo URLROOT; ?>/employees/monthlyMakeReservation" method="post" class="input-group" >
        <div class="column">
            <section class="section">
                <label class="topic" for="monthly_schedule">Schedule Type</label></br>
                <select name="schedule" id="monthly_schedule" class="schedule" onchange="changeRouteMonthly()" value="<?php echo $data['scheduleType']; ?>">
                    <option value="Select">Select</option>
                    <option value="ToWork">To work</option>
                    <option value="FromWork">From work</option>
                    <option value="BothWays">Both ways</option>
        ...
        <div class="column">
                <section class="section">
                    <span class="date-topic"></span> <label for="reservationStartDate">Reservation Start Date</label></span><br>
                    <div class="date">
                        <input type="date" id="reservationStartDate" name="StartDate" placeholder="Reservation Start Date">
                    </div>
                </section>

                <section class="section">
                    <span class="date-topic"></span> <label for="reservationEndDate">Reservation End Date</label></span><br>
                    <div class="date">
        ...
        <div class="column">
            <section class="section" id="monthly_pickup">
                ...
                <div class="pickup"> <input type="text" id="monthly_pickup" name="pickup" placeholder="Enter pickup city" value="<?php echo $data['pickup']; ?>"></div>
            </section>

            <section class="section" id="monthly_dropoff">
                <span class="drop-topic"></span><label for="monthly_dropoff">Drop Off</label>
                <div class="pickup">  <input type="text" id="monthly_dropoff" name="dropoff" placeholder="Enter drop off city" value="<?php echo $data['dropoff']; ?>"></div>
            </section>
        </div>
