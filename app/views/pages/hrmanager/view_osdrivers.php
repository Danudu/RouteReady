...
<head>
    ...
    <title>OS-Drivers | RouteReady</title>
                        ...
                        <?php if (!empty($data['drivers'])): ?>
                            <?php foreach ($data['drivers'] as $driver): ?>
                                <tr>
                                    ...
                                    <td><?php echo $driver->designation; ?></td>
                                    <td><?php echo $driver->status; ?></td>
                                    <td><a class="button"
                                            href="<?php echo URLROOT; ?>/hrmanagers/moreOSDriver/<?php echo $driver->id; ?>">More</a>
                                    </td>
