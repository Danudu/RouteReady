...
class Drivers extends Controller
{
  ...
  private SalaryReportModel $salaryReportModel;
  private $userModel;
  ...
  //   $this->salaryReportModel = $this->model('SalaryReportModel');
  // }
  ...
  //     $result= $this->bankDetailsModel->editBankDetails($driver_id, $accountNo, $bankName, $branchName, $holderName);
  //   }else{
  //   }
...
//     public function generateSalaryReport($driver_id) {
//         $model = new SalaryReportModel();
//         $salary_data = $model->getSalaryData($driver_id);
//         $bank_data = $model->getBankData($driver_id);
//         $model->closeConnection();

//         return array('salary_data' => $salary_data, 'bank_data' => $bank_data);
//     }
}
