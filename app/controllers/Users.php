...
class Users extends Controller
{
    ...
    //             'department' => trim($_POST['department']),
    //             'designation' => trim($_POST['designation']),
    //             'driver_license' => trim($_POST['driver_license']), // New attribute
    //             'vehicle_type' => trim($_POST['vehicle_type']), // New attribute
    //             'name_err' => '',
    //             'email_err' => '',
    //             'password_err' => '',
    //             'confirm_password_err' => '',
    ...
    //                 // If the user is a driver, insert additional data into the driver table
    //                 if($data['designation'] == 'driver') {
    //                     $driverData = [
    //                         'user_id' => $user_id,
    //                         'driver_license' => $data['driver_license'],
    ...
    //                 'department' => '',
    //                 'designation' => '',
    //                 'driver_license' => '', // New attribute
    //                 'vehicle_type' => '', // New attribute
    //                 'name_err' => '',
    //                 'email_err' => '',
    //                 'password_err' => '',
    //                 'confirm_password_err' => '',
